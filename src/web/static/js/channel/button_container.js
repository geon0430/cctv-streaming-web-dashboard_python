document.addEventListener('DOMContentLoaded', () => {
    function initialize() {
        ...
        addChannelButton.addEventListener('click', () => {
            console.log("addChannelButton clicked");
            openModal();
        });
        ...
        document.addEventListener('click', (event) => {
            if (event.target && event.target.id === 'cancel-button') {
                ...
                closeModal();
            } else if (event.target && event.target.id === 'add-group') {
                console.log("addGroupButton clicked");
                openGroupModal();
            } else if (event.target && event.target.id === 'save-group') {
                console.log("saveGroupButton clicked");
                addGroup();
            } else if (event.target && event.target.id === 'cancel-group') {
                console.log("groupCancelButton clicked");
                closeGroupModal();
            }
        });
        ...
        function displayResults(data, queryData) {
            ...
            modalContent.addEventListener('dragstart', function (event) {
                event.preventDefault();
            });
