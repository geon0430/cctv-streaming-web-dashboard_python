...
@put_router.put("/list/{id}", response_model=ChannelDBStruct)
async def PUT_Router(id: int, device: ChannelDBStruct, logger=Depends(get_logger),db_manager=Depends(get_channel_db)):
